...
public class ResourceTypeApi  {
   ...
   private final ResourceTypeApiService delegate = ResourceTypeApiServiceFactory.getResourceTypeApi();
    ...
    public Response resourceTypeDelete(@ApiParam(value = "This represents the resource type to be deleted." ,required=true ) ResourceTypeRequestDTO type)
    {
    return delegate.resourceTypeDelete(type);
    }
    @GET
    ...
    public Response resourceTypeGet(@ApiParam(value = "This represents the resource type to be retrieved." ,required=true ) ResourceTypeRequestDTO type)
    {
    return delegate.resourceTypeGet(type);
    }
    @PATCH
